...
const messages = [
    "Gửi đến người phụ nữ tuyệt vời nhất trong aacuộc đời anh, em mang đến niềm vui và hạnh phúc cho mỗi ngày.",
    "Nụ cười của em thắp sáng thế giới của anh, và abc123ình yêu của em lấp đầy trái tim anh bằng sự ấm áp.",
    "Vào ngày đặc biệt này, anh muốn em biết em có ý nghĩa như thế nào đối với anh.",
    "Em không chỉ là bạn gái của anh, em là bạn thggggân nhất của anh, là người bạn tâm giao và là tất cả của anh.",
    "Anh trân trọng từng khoảnh khắc chúng ta bên nhau, và anh mong muốn tạo ra nhiều kỷ niệm đẹp hơn nữa.",
    "Chúc mừng Ngày Phụ nữ, tình yêu của anh! Em xứng uuuđáng có được tất cả hạnh phúc trên thế giới này."
];
